    ...
    <section className="relative min-h-[700px] w-full overflow-hidden flex flex-col pt-28 lg:pt-32 xl:pt-36 pb-24 lg:pb-48">
      ...
      <div className="container relative z-20 mx-auto px-5 lg:px-[60px]">
        <div className="max-w-3xl">
          {/* Animated Badge */}
          <div className="mb-8 inline-flex items-center gap-3 rounded-full bg-white/10 px-6 py-2 text-xs font-bold uppercase tracking-[0.3em] text-white backdrop-blur-md ring-1 ring-white/20 animate-fade-in-up">
          ...
          <h1
            ...
            className="mb-8 font-serif text-[clamp(52px,7vw,88px)] font-bold leading-[1.05] tracking-tight text-white animate-fade-in-up [animation-delay:200ms]"
          ...
          {/* Subtitle */}
          <p className="mb-12 max-w-xl text-lg leading-relaxed text-white/80 animate-fade-in-up [animation-delay:400ms]">
          ...
          <div className="flex flex-col gap-4 sm:flex-row animate-fade-in-up [animation-delay:600ms]">
            <a
              ...
              className="group flex items-center justify-center gap-3 rounded-2xl bg-white px-8 py-5 text-sm font-black uppercase tracking-widest text-[var(--navy)] transition-all hover:bg-[var(--gold)] hover:text-white shadow-xl shadow-white/5"
            >
              Explore Packages
            ...
            <a
              ...
              className="group flex items-center justify-center gap-3 rounded-2xl border-2 border-white/20 px-8 py-5 text-sm font-black uppercase tracking-widest text-white backdrop-blur-sm transition-all hover:bg-white/10"
            >
              Learn More
